...
However, there are some cases where this could be a helpful feature, especially in converging to a stable signal and allowing the noise to fade away. Thus, the SNR of the resulting signal is significantly better compared to a classical fft.
...
A simple implementation of the ideas discussed above can be found in my github. I am planning to further understand and refine the brain inspired fft over this winter break, excited to see what comes out of it!
