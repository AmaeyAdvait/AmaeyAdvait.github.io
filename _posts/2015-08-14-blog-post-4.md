...
This approach gives us infinite variability, an infinite vocabulary and infinite expressivity. Further, from a cryptography perspective, continuous language models are definitely harder to crack, since many continuous random variables cannot be inverted easily, especially if they are densely correlated. Similar ideas have already been implemented in supercomputer architectures. 
