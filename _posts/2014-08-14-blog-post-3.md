...
It felt excruciatingly tiring, knowing every time entering the lab that there will be some deviation from the expected results. I couldn't understnad why somebody hadn't come up with a reliable solution. So imagine my surprise when we were successfully able to design an RC phase shift oscillator in under two hours during the next lab! The output was exceptionally table and the target frequency was exactly what we had calculated it to be.
