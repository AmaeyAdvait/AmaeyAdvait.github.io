...
2. Diameter: If the threshold is set between 5 and 25 cm, with a precision of 0.1 cm, we get:-
   <p>$\log2((25-5)/0.1) = log2(200) = 8 bits(rounded up)\$</p>
   \log_{2}\left(\frac{\left(25-5\right)}{0.1}\right)\ =\ \log_{2}\left(200\right)\ =\ 8\ bits\left(\operatorname{round}\ up\right)

3. Consider an array of 128 possible materials for a ball:-
   <p>$\log2(128) = 7 bits\$</p>

4.Consider a background of 1000x1000 pixels:-
   <p>$\log2(10^6) = 20 bits(rounded up)\$</p>

Hence, the total number of bits required is 59 bits, or in the range of <p>$\[40,80\]$</p> bits on average.
