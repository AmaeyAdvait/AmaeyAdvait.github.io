...
A Visual Thought Experiment(Why?)
=================================
...
Of course, these numbers mentioned above are strictly hypothetical and the notions of what neuroAI systems could do are still in its very nascent stages. In the upcoming posts, we will discuss more regarding what neuroAI systems are, what are some methods to implement the ideas discussed and how they can be applied to improve different facets of the human experience.
